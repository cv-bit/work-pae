...
const Books = ({fontColor, color, setFontColor, setColor}) => {
  return (
    <div className="books-container">
        ...
        <Link className="sample-reader-btn" to="/samplereader" style={{color: fontColor, backgroundColor: color, padding: "15px", borderRadius: "10px", margin: "auto"}}>go to sample reader</Link>
    </div>
  )
}
